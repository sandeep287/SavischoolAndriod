...
public class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        try {
            ...
            if (! file.exists()) {
                ...
                OutputStream output = new FileOutputStream(Environment.getExternalStorageDirectory()
                                                                   .getPath() + File.separator + "Savischool/" +
                                                                   fileName);
    ...
    protected void onProgressUpdate(String... values) {
        ...
        len = values.length;
        if (counter >= len - 1) {
            builder.setContentTitle("SaviSchools");
...
//        Uri uri = Uri.fromFile(file);
        ...
        } else if (filetype.equals(".3gp") || filetype.equals(".mpg") || filetype.equals(".mpeg") || filetype
                                                                                                             .equals(".mpe") || filetype.equals(".mp4") || filetype.equals(".avi")) {
